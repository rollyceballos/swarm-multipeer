...
#ifndef SWARMMULTIPEER_SWIFT_H
#define SWARMMULTIPEER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwarmMultiPeer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class MCPeerID;

SWIFT_CLASS("_TtC14SwarmMultiPeer11SwarmClient")
@interface SwarmClient : NSObject
@property (nonatomic, copy) NSArray<MCPeerID *> * _Nonnull connectedPeers;
...
@interface SwarmClient (SWIFT_EXTENSION(SwarmMultiPeer)) <MCNearbyServiceBrowserDelegate>
...
@interface SwarmClient (SWIFT_EXTENSION(SwarmMultiPeer)) <MCSessionDelegate>
...
SWIFT_CLASS("_TtC14SwarmMultiPeer9SwarmHost")
@interface SwarmHost : NSObject
@property (nonatomic, copy) NSArray<MCPeerID *> * _Nonnull connectedPeers;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface SwarmHost (SWIFT_EXTENSION(SwarmMultiPeer)) <MCNearbyServiceAdvertiserDelegate>
...
@interface SwarmHost (SWIFT_EXTENSION(SwarmMultiPeer)) <MCSessionDelegate>
- (void)session:(MCSession * _Nonnull)session peer:(MCPeerID * _Nonnull)peerID didChangeState:(MCSessionState)state;
- (void)session:(MCSession * _Nonnull)session didReceiveData:(NSData * _Nonnull)data fromPeer:(MCPeerID * _Nonnull)peerID;
- (void)session:(MCSession * _Nonnull)session didReceiveStream:(NSInputStream * _Nonnull)stream withName:(NSString * _Nonnull)streamName fromPeer:(MCPeerID * _Nonnull)peerID;
- (void)session:(MCSession * _Nonnull)session didStartReceivingResourceWithName:(NSString * _Nonnull)resourceName fromPeer:(MCPeerID * _Nonnull)peerID withProgress:(NSProgress * _Nonnull)progress;
